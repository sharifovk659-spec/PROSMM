...
const programModulesRu: LocaleDictionary["programModules"] = [
  ...
  },
  {
    ...
    outcome:
      "Основы продаж через контент и коммуникацию.",
  },
  {
    number: 7,
    ...
    lessons: [],
    outcome:
      "Делегируете задачи и масштабируете блог и бизнес.",
  },
  {
    number: 8,
    title: "Блог без лица",
  ...
  },
  {
    ...
    lessons: [],
    outcome:
      "Используете AI-инструменты для контента и SMM.",
  },
  {
    number: 10,
    ...
    lessons: [],
    outcome:
      "Стратегия крупного бизнеса и SMM-агентства.",
  },
];
