...
const programModulesTj: LocaleDictionary["programModules"] = [
  ...
  },
  {
    ...
    outcome:
      "Асосҳои фурӯш тавассути контент ва коммуникация.",
  },
  {
    number: 7,
    ...
    lessons: [],
    outcome:
      "Вазифаҳоро делегатсия карда, блог ва бизнесро масштаб мекунед.",
  },
  {
    number: 8,
    title: "Блог бе рӯй",
    lessons: [],
    outcome:
      "Блогро бе нишон додани рӯй бурда метавонед.",
  },
  {
    number: 9,
    ...
    lessons: [],
    outcome:
      "Асбобҳои AI-ро барои контент ва SMM истифода мебаред.",
  },
  {
    number: 10,
    ...
    lessons: [],
    outcome:
      "Стратегияи тиҷорати калон ва агентсии SMM.",
  },
];
