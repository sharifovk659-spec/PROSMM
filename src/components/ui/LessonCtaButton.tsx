...
export function LessonCtaButton({ label, className = "" }: LessonCtaButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-[#ff9652]/45 bg-[#ff7a2f]/15 px-2.5 py-1 font-[family-name:var(--font-oswald)] text-[9px] font-semibold uppercase tracking-[0.12em] text-[#ffb07a]">
        <ClickFingerIcon />
        {uiLabels.clickHint}
      </span>
    </motion.button>
