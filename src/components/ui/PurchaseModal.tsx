...
export function PurchaseModal({ open, planName, onClose }: PurchaseModalProps) {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    // Instagram-style: client opens WhatsApp and writes TO the business.
    // When they tap Send, the message arrives as INCOMING in that client's chat on the owner's phone.
