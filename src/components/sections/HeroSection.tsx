...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="pointer-events-none absolute right-4 top-[4.5rem] z-50 hidden sm:top-[5rem] lg:block">
        <div className="pointer-events-auto">
          <LanguageSwitcher />
        </div>
      </div>

      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col section-padding-inline pb-8 pt-[7.5rem] sm:pb-10 sm:pt-32 lg:pb-12">
